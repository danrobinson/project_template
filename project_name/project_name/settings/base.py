...
EMAIL_HOST_USER = 'gottagetmac@gmail.com'
EMAIL_HOST_PASSWORD = environ['EMAIL_HOST_PASSWORD']
EMAIL_PORT = 587
EMAIL_USE_TLS = True

DEFAULT_FROM_EMAIL = 'gottagetmac@gmail.com'
...
DEFAULT_DB = ('postgres://postgres:' +
              environ['DATABASE_PASSWORD'] +
              '@localhost:5432/{{ project_name }}')
...
SECRET_KEY = r"+zby+0ckx7(329b6hgouo19o_6$ylerqslgu*v=a!ek+(_0+%1"
